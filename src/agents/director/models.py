...
from src.models.models import Scene, VideoScript, VisualSegment
...
class DirectedScene(BaseModel):
    ...
    # TICKET-035: Visual Segments with detailed prompts
    visual_segments: List["VisualSegment"] = Field(
        default_factory=list,
        description="List of visual segments with detailed image prompts generated by Director"
    )
